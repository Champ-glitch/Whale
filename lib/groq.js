...
{
  "intent": "pay" | "link" | "invoices" | "today" | "stats" | "help" | "deduct" | "setbalance" | "balance" | "chat",
...
- Return "balance" for requests like "what's my balance", "how much do I have".
...
export async function parseIntent(userMessage, history = []) {
  ...
  try {
    ...
    const validIntents = ["pay", "link", "invoices", "today", "stats", "help", "deduct", "setbalance", "balance", "chat"];
